#!/bin/bash
# Copy certificates from standalone certbot to FreeRADIUS project
...
CERT_DEST_DIR="$FREERADIUS_PROJECT_PATH/docker/freeradius/certs"

echo "Copying certificates to FreeRADIUS project..."
...
echo "✓ Certificates copied to FreeRADIUS project successfully"